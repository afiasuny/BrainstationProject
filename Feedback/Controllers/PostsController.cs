...
namespace Feedback.Controllers
{
    public class PostsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PostId,Post,UserId,PostTime")] Posts posts)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpGet]
        public string GetPost(string post, int page )
        {
            var postsViewModelList =  _postService.GetPost(post, page);
